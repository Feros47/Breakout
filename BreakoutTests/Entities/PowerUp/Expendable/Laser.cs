...
public class Laser {
    ...
    public void TestDeleteEntity() {
        ...
        Assert.That(powerUp.ShouldIgnore(), Is.True);
    }
    ...
    [Test]
    public void TestAcceptCollisionUnbreakable() {
        powerUp.AcceptCollision(new UnbreakableBlockCollisionVisitor(), new CollisionData() { Collision = true });
        Assert.That(powerUp.IsDeleted(), Is.True);
    }
    [Test]
